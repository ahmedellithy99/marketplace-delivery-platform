...
const form = useForm({
    ...
    role: props.staffMember.role || "admin",
    password: "",
    password_confirmation: "",
});

function submit() {
    form.post(`/admin/staff/${props.staffMember.id}`);
}
</script>

<template>
    <AdminLayout title="تعديل موظف">
        <div class="max-w-3xl mx-auto">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                >
                    ...
                    >
                        {{ form.processing ? "جاري الحفظ..." : "تحديث الموظف" }}
                    </button>
                    <Link
                        href="/admin/staff"
